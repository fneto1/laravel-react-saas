...
class DifferenceController extends Controller
{
    ...
    public function __construct(){
        $this->feature = Feature::where("route_name", "diff.index")->where("active", true)->firstOrFail();
    }

    public function index(){
        return inertia("Difference/Index", [
    ...
    public function calculate(Request $request){
        ...
        return to_route('diff.index')->with('answer', $number1 - $number2);
    }
}
