...
class SumController extends Controller
{
    ...
    public function __construct(){
        $this->feature = Feature::where("route_name", "sum.index")->where("active", true)->firstOrFail();
    }

    public function index(){
        return inertia("Sum/Index", [
    ...
    public function calculate(Request $request){
        ...
        return to_route('sum.index')->with('answer', $number1 + $number2);
    }
